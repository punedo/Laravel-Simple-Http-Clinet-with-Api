    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="bbb_deals">
                    ...
                    <div class="bbb_deals_title">{{$data['title']}}</div>
                    <div class="bbb_deals_slider_container">
                        <div class=" bbb_deals_item">
                            <div class="bbb_deals_image"><img src="{{$data['thumbnail']}}" class="img-fluid" alt=""></div>
                            <div class="bbb_deals_content">
                                <div class="bbb_deals_info_line d-flex flex-row justify-content-start">
                                    <div class="bbb_deals_item_category"><a href="#">{{$data['brand']}}</a></div>
                                    <div class="bbb_deals_item_price_a ml-auto"><strike>₹{{$data['discountPercentage']}}></strike></div>
                                </div>
                                <div class="bbb_deals_info_line d-flex flex-row justify-content-start">
                                    <div class="bbb_deals_item_name">{{$data['category']}}</div>
                                    <div class="bbb_deals_item_price ml-auto">₹{{$data['price']}}</div>
                                </div>
                                <div class="available">
                                    <div class="available_line d-flex flex-row justify-content-start">
                                        <div class="available_title">Available: <span>{{$data['stock']}}</span></div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <a class="btn btn-primary btn-block" href="{{url('single',$data['id'])}}">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
