        ...
        <div class="col-md-3">
            <!-- bbb_deals -->
                ...
                <div class="bbb_deals">
                    ...
                    <div class="bbb_deals_title">{{$item['title']}}</div>
                    <div class="bbb_deals_slider_container">
                        <div class=" bbb_deals_item">
                            <div class="bbb_deals_image"><img src="{{$item['thumbnail']}}" class="img-fluid" alt=""></div>
                            <div class="bbb_deals_content">
                                <div class="bbb_deals_info_line d-flex flex-row justify-content-start">
                                    <div class="bbb_deals_item_category"><a href="#">{{$item['brand']}}</a></div>
                                    <div class="bbb_deals_item_price_a ml-auto"><strike>₹{{$item['discountPercentage']}}></strike></div>
                                </div>
                                <div class="bbb_deals_info_line d-flex flex-row justify-content-start">
                                    <div class="bbb_deals_item_name">{{$item['category']}}</div>
                                    <div class="bbb_deals_item_price ml-auto">₹{{$item['price']}}</div>
                                </div>
                                <div class="available">
                                    <div class="available_line d-flex flex-row justify-content-start">
                                        <div class="available_title">Available: <span>{{$item['stock']}}</span></div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <a class="btn btn-primary btn-block" href="{{url('single',$item['id'])}}">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
